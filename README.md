...
- 관심 주제 기반 무료 웹 자료 탐색
- 국내외 기관별 이슈리포트·연구보고서·시장보고서 탐색
- 관련도 70점 이상인 수집 후보만 표시
- 관련도 90점 이상 고신뢰 자료 자동 저장과 중복 제거
- 수집 후보 저장, 제외, 출처 차단
- 모아·Daily Desk·웹 조사 자료를 종합한 주간·월간 이슈 중심 보고서
- GitHub `report/weekly`, `report/monthly` 보고서 보관·열람
- 보고서 복사 및 Markdown 다운로드
